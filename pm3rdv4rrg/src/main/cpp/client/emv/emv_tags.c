...
static const struct emv_tag_bit EMV_TVR[] = {
    ...
    { EMV_BIT(2, 8), "ICC and terminal have different maps versions" },
    { EMV_BIT(2, 7), "Expired maps" },
...
static const struct emv_tag emv_tags[] = {
    ...
    { 0xdf8124, "Reader Contactless Transaction Limit (No On-devices CVM)",     EMV_TAG_GENERIC,  NULL },
    { 0xdf8125, "Reader Contactless Transaction Limit (On-devices CVM)",        EMV_TAG_GENERIC,  NULL },
    ...
    for (i = 8; i < tlv->len; i += 2) {
        ...
        switch (tlv->value[i + 1]) {
            ...
            case 0x05:
                ...
                break;
            case 0x06:
                condition = "If transaction is in the maps currency and is under X value";
                break;
            case 0x07:
                condition = "If transaction is in the maps currency and is over X value";
                break;
            case 0x08:
                condition = "If transaction is in the maps currency and is under Y value";
                break;
            case 0x09:
                condition = "If transaction is in the maps currency and is over Y value";
                break;
            default:
                condition = "Unknown";
                break;
