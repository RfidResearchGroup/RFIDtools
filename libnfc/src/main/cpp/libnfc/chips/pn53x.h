...
int pn53x_unwrap_frame(const uint8_t *pbtFrame, const size_t szFrameBits, uint8_t *pbtRx,
                       uint8_t *pbtRxPar);
...
int pn53x_write_register(struct nfc_device *pnd, uint16_t ui16Reg, uint8_t ui8SymbolMask,
                         uint8_t ui8Value);
...
// NFC devices as Initiator functions
...
int pn53x_initiator_transceive_bits_timed(struct nfc_device *pnd, const uint8_t *pbtTx,
                                          const size_t szTxBits,
                                          const uint8_t *pbtTxPar, uint8_t *pbtRx,
                                          uint8_t *pbtRxPar, uint32_t *cycles);

int pn53x_initiator_transceive_bytes_timed(struct nfc_device *pnd, const uint8_t *pbtTx,
                                           const size_t szTx,
...
// NFC devices as Target functions
int pn53x_target_init(struct nfc_device *pnd, nfc_target *pnt, uint8_t *pbtRx, const size_t szRxLen,
                      int timeout);

int pn53x_target_receive_bits(struct nfc_device *pnd, uint8_t *pbtRx, const size_t szRxLen,
                              uint8_t *pbtRxPar);

int pn53x_target_receive_bytes(struct nfc_device *pnd, uint8_t *pbtRx, const size_t szRxLen,
                               int timeout);

int pn53x_target_send_bits(struct nfc_device *pnd, const uint8_t *pbtTx, const size_t szTxBits,
                           const uint8_t *pbtTxPar);

int pn53x_target_send_bytes(struct nfc_device *pnd, const uint8_t *pbtTx, const size_t szTx,
                            int timeout);
...
int pn53x_InListPassiveTarget(struct nfc_device *pnd, const pn53x_modulation pmInitModulation,
                              ...
                              const size_t szInitiatorDataLen, uint8_t *pbtTargetsData,
...
int pn53x_InAutoPoll(struct nfc_device *pnd, const pn53x_target_type *ppttTargetTypes,
...
int pn53x_RFConfiguration__MaxRetries(struct nfc_device *pnd, const uint8_t MxRtyATR,
...
int pn53x_check_error_frame(struct nfc_device *pnd, const uint8_t *pbtRxFrame,
