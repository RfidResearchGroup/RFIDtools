...
#include "cmdmain.h"     // for sending cmds to devices
...
/* write a command before reading */
...
static command_t CommandTable[] = 
{
	...
	{"cmdread",     CmdLFCommandRead,   0, "<d period> <z period> <o period> <c command> ['H'] -- Modulate LF reader field to write command before read (all periods in microseconds) (option 'H' for 134)"},
