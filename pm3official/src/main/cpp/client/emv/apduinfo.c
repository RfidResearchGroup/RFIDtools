...
const APDUCode APDUCodeTable[] = {
	...
	{"91A1", 	APDUCODE_TYPE_NONE, 		"Unrecoverable error within maps"},
	...
	{"91DE", 	APDUCODE_TYPE_NONE, 		"File or maps already exists"},
	...
	{"9862", 	APDUCODE_TYPE_ERROR,		"Authentication Error, maps specific (incorrect MAC)"},
	...
	{"9D10", 	APDUCODE_TYPE_ERROR,		"Insufficient memory to load maps"},
	...
	{"9D64", 	APDUCODE_TYPE_ERROR,		"No maps loaded"},
