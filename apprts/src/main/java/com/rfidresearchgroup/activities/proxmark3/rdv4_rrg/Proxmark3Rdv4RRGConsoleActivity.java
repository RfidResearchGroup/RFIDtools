...
import static com.rfidresearchgroup.common.util.FileUtils.getNativePath;
...
import com.rfidresearchgroup.adapter.EasyBtnAdapter;
import com.rfidresearchgroup.javabean.EasyCMDEntry;
import com.rfidresearchgroup.rfidtools.R;
import com.rfidresearchgroup.util.EasyBtnUtil;
...
import com.rfidresearchgroup.common.widget.DoubleInputDialog;
...
public class Proxmark3Rdv4RRGConsoleActivity
    ...
    protected boolean prepareConsole() {
        ...
        start(getNativePath() + File.separator + "libpm3rrg_cmd.so", "socket:DXL.COM.ASL", "--flush");
        return true;
    }
