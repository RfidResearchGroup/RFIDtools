...
//-----------------------------------------------------------------------------
// There are three basic operation modes, depending on which devices (proxmark/pc)
...
int usage_15_samples(void){
	PrintAndLogEx(NORMAL, "Acquire samples as Reader (enables carrier, write inquiry\n"
