...
int usage_hf_snoop(){
	...
	PrintAndLogEx(NORMAL, "The high frequence snoop will assign all available memory on devices for snooped data");
	PrintAndLogEx(NORMAL, "User the 'data samples' command to download from devices,  and 'data plot' to look at it");
